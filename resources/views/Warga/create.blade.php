...
@section('title', 'Sistem Manajemen Warga - Tambah Warga')

@section('content')
    <div class="mb-8">
        <h2 class="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">
            Tambah Warga</h2>
        <p class="font-body-lg text-body-lg text-on-surface-variant mt-2">Isi data warga baru. Akun akan dibuat otomatis dan menunggu aktivasi.</p>
    </div>
    ...
    <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
        <form action="{{ route('super_admin.warga.store') }}" method="POST" class="p-6 space-y-4">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="rt" required maxlength="10"
                        class="w-full bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2.5 font-body-sm focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="font-body-sm font-semibold text-on-surface mb-1 block">Kelurahan</label>
                    <input type="text" name="kelurahan" required maxlength="255"
                        class="w-full bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2.5 font-body-sm focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="font-body-sm font-semibold text-on-surface mb-1 block">Kecamatan</label>
                    <input type="text" name="kecamatan" required maxlength="255"
                        class="w-full bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2.5 font-body-sm focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="font-body-sm font-semibold text-on-surface mb-1 block">Kota</label>
                    <input type="text" name="kota" required maxlength="255"
                        class="w-full bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2.5 font-body-sm focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="font-body-sm font-semibold text-on-surface mb-1 block">Alamat</label>
                    <textarea name="alamat" required rows="3"
                        class="w-full bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2.5 font-body-sm focus:outline-none focus:ring-2 focus:ring-primary"></textarea>
                </div>
            </div>
