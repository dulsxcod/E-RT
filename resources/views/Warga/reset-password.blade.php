    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                <h1 class="font-headline-lg text-headline-lg text-on-surface">Ganti Password</h1>
                <p class="font-body-sm text-body-sm text-on-surface-variant mt-2">Buat password baru Anda.</p>
            </div>
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
                <form action="{{ route('warga.reset-password.submit') }}" method="POST" class="p-6 space-y-4">
                    @csrf
                    <div>
                        <label class="font-body-sm font-semibold text-on-surface mb-1 block">Password Baru</label>
